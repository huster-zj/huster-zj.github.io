...
\begin{document}
	...
	\datedsubsection{\textbf{开源项目汇总研究导航} \hspace{2em} \textit{个人项目 \hspace{2em}  \href{https://roadmap.sh/r/rdm-ud9x6}{https://roadmap.sh/r/rdm-ud9x6}}}{2022.9 -- 至今}
	...
	\datedsubsection{\textbf{航天器任务调度原型系统开发} \hspace{2em} \textit{国自然重点项目、核心开发}}{2024.5 -- 至今}
	\large \highlight{简要介绍：研发通用调度分析工具软件，为复杂航天任务提供全流程支持}
	\begin{itemize}
	...
	\datedsubsection{\textbf{航天调度模型微调与Agent规划技术研究} \hspace{2em} \textit{科研探索项目、独立开发} }{2025.4 -- 2025.6}
	\large \highlight{简要介绍：基于LLama-Factory框架在华科高性能计算平台进行大模型微调；进行Agent规划技术相关的科研探索。}
	\begin{itemize}
	...
	\begin{center}
		\begin{tabular}{@{}ccc@{}} 
			\raisebox{10pt}{\includegraphics[width=0.28\textwidth]{fujian/7_航天器任务调度原型系统.png}} \\ 
			\small\parbox{0.28\textwidth}{\centering 航天器任务调度原型系统}
		\end{tabular}
	\end{center}
