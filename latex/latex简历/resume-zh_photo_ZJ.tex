...
\begin{document}
	...
	\section{\faUser\ 自我评价}
	\hspace{2em}我致力于构建并长期践行一套属于自己为人处世的第一性原理（性格-认知-能力-身体素质-资金）。信奉长期主义，热爱阅读前沿论文、聆听深度访谈播客，始终保持极强的创新思维。我的终极梦想，是打造一款能够改变世界的伟大产品。
	
	\hspace{2em}作为 ENFJ 型人格，我酷爱思考与总结，不断从学习实践中提炼属于自己的理论方法。此外，我会定期整理高价值学习路径，方便自己随时回溯与分享。以下是我自己梳理的常用的资源地图：
	\begin{itemize}[parsep=0.5ex, leftmargin=1.5em]
	    ...
	    \item MBSE（基于模型的系统工程）：\href{https://roadmap.sh/r/mbse}{\textcolor{darkgreen}{https://roadmap.sh/r/mbse}}
	    \item 科研相关：\href{https://roadmap.sh/r/rdm-vnkne}{\textcolor{darkgreen}{https://roadmap.sh/r/rdm-vnkne}}
	\end{itemize}
